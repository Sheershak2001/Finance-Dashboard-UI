const Sidebar = ({ darkMode }) => {
  return (
    <div
      className={`hidden md:flex w-56 border-r p-5 flex-col gap-6 ${
        darkMode ? 'bg-white/3 border-white/10' : 'bg-white border-gray-200'
      }`}
    >
      <div>
        <h2
          className={`font-black text-lg tracking-tight ${darkMode ? 'text-white' : 'text-gray-900'}`}
        >
          FIN
        ...
        <p
          className={`text-xs mt-1 ${darkMode ? 'text-white/30' : 'text-gray-400'}`}
        >
          Finance Dashboard
        </p>
      </div>
      ...
      <div className='mt-auto'>
        ...
        >
          ...
          <div>
            ...
            <p
              className={`text-xs ${darkMode ? 'text-white/30' : 'text-gray-400'}`}
            >
              Admin
            </p>
          </div>
